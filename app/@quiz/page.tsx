      ...
      {questions.length && !loading && (
        <div className="max-w-screen-xl flex-wrap items-center mx-auto p-4 pb-0 flex justify-center mt-10">
          <h1 className="mb-4 mt-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-3xl lg:text-3xl">
            <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-800">Question Number</span>
          </h1>
        </div>
      )}
              ...
              <div className="grid grid-cols-2 gap-4">
                {questions[0].answers.map((Answer, index) => (
                  <button
                    ...
                    className={cn(
                      "w-full py-3 px-4 bg-gray-100 text-gray-800 rounded-md shadow-md hover:bg-blue-500 hover:text-white transition duration-300",
                      {
                        "bg-red-500 hover:bg-red-500": answer && Answer !== answer,
                        "bg-blue-500 hover:bg-blue-500": answer && Answer === answer,
