  ...
  return (
    ...
    <>
      ...
      <div className="max-w-screen-xl flex-wrap items-center mx-auto p-4 flex justify-center mt-10">
        <h1 className="mb-4 mt-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-5xl ">Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">QuizQuest...</span></h1>
      </div>
      <div className="max-w-screen-xl flex-wrap items-center mx-auto p-4 flex justify-center">
        <div className="p-10 my-10 rounded-lg shadow-xl w-[65%]">
          <Input placeholder="number of questions" type="number" defaultValue={10} min={0} max={15} onChange={(e)=>addNumberOfQuestions(e.target.value)} />
